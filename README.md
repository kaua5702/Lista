## 📖 Descrição
Este projeto demonstra o uso da interface List em Java, utilizando a implementação ArrayList para armazenar objetos da classe User.
O programa cria uma lista de usuários, adiciona elementos dinamicamente e exibe informações específicas, mostrando na prática como manipular coleções em Java.
